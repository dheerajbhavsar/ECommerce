...
internal sealed class ProductCatalog : StatefulService
{
    ...
    protected override async Task RunAsync(CancellationToken cancellationToken)
    {
        ...
        var product1 = new Product
        {
            Id = Guid.NewGuid(),
            Name = "Yogabook",
            Description = "Lenovo yogabook for new generation",
            Price = 150,
            Availability = 12
        };
        var product2 = new Product
        {
            Id = Guid.NewGuid(),
            Name = "MacBook",
            Description = "Apple MacBook for new generation",
            Price = 150,
            Availability = 12
        };
        var product3 = new Product
        {
            Id = Guid.NewGuid(),
            Name = "DELL LATITUDE",
            Description = "DELL professional laptop",
            Price = 150,
            Availability = 12
        };
        var product4 = new Product
        {
            Id = Guid.NewGuid(),
            Name = "Vivo Laptop",
            Description = "Vivo yogabook for new generation",
            Price = 150,
            Availability = 15
        };
